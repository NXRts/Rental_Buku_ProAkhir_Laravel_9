...
@section('content')
    ...
    <style>
        ...
        .zoomable-image {
            cursor: pointer;
            /* Mengubah kursor menjadi pointer saat mengarahkan ke gambar */
            transition: transform 0.2s;
            /* Efek transisi saat gambar berubah ukuran */
        }

        /* CSS untuk efek zoom in saat gambar dihover */
        .zoomable-image:hover {
            transform: scale(1.2);
            /* Memperbesar gambar sebesar 20% saat dihover */
        }

        /* CSS untuk efek zoom in saat gambar diklik */
        .zoomable-image.clicked {
            transform: scale(1.5);
            /* Memperbesar gambar sebesar 50% saat diklik */
        }
    </style>
    ...
    <div class="mt-5 w-50">
        ...
        <form action="/book-edit/{{ $book->slug }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                @if ($book->cover != '')
                    <img class="zoomable-image" src="{{ asset('storage/cover/' . $book->cover) }}" alt=""
                        width="300px">
                @else
